...
This professional self-assessment will serve as a formal introduction to my educational experience in the Computer Science program at Southern New Hampshire University, and will summarize the artifacts that were selected to showcase my strengths as a Software Engineer. 

### Program Experience
Prior to enrolling in the Computer Science program at SNHU I worked in the technology industry for 11 years after achieving an AAS degree in Electronics Technology after high school. After 11 years of working in a semiconductor manufacturing plant and with few opportunities to advance further in my role, I decided that it was time for a career change and pursue a new career in computer science, as I had always been fascinated and interested in learning how to become a computer programmer.   

Over the last few years, I have learned many valuable skills and applied them in various class assignments and projects throughout my time at SNHU.  

One of my favorite classes in the Computer Science program at SNHU is CS-310, where I was first introduced to the importance of version control tools in software development. Version control tools enables software development teams to store source code in a centralized location and develop and test new features on different branches of the source code. This allows developers to easily go back to older versions of the source code in case new features introduce bugs that are difficult to remove. I enjoyed this class a great deal because it was my first real experience collaborating with fellow programmers and learning how to use Git to manage and modify source code within a software development team. This class was also my first experience in performing peer code reviews and resolving issues in a productive and professional manner.

Another class that I enjoyed is DAT-220, Fundamentals of Data Mining. The final project for this class consisted of planning, conducting, and reporting on a data mining initiative for a struggling restaurant chain with the goal of creating new revenue growth. The data mining tool JMP was used in this project to analyze the restaurant chain’s customer data warehouse and identify natural clusters of customer activity that indicates specific demographics of the restaurant’s customer population that provide the majority of their business. With this customer survey analysis, the restaurant chain can then decide if they want to focus their marketing campaigns to their loyal customers or direct their marketing campaigns to reach other demographic groups. 

Learning the importance of data structures and algorithms was experienced in CS-260, where I learned how vectors, hash tables, and tree structures are utilized to obtain better efficiency when data searches are performed. This class also provided a great foundation of knowledge of algorithms and when to use specific algorithm methods to achieve the best performance and efficiency. I learned to utilize linear array searches only when the amount of data is small, and when to utilize algorithms with binary trees for searching and sorting through large amounts of data in the quickest manner. 

While taking the introduction to SQL class in DAD-220, I received my first experience working with databases. Thanks to this class I learned how to manage a database using structured query language (SQL) and manage database schemas, manipulate data, and analyze data. This class covered the basics of creating databases from scratch, altering existing databases and manipulating the data within it, and data retrieval. 

While all of the aforementioned classes have provided me with a solid foundation of skills in computer science, CS-405 was the secure coding class that really highlighted the importance of ensuring that any programs we create are always secure and free of vulnerabilities that hackers can potentially exploit. Hackers can exploit vulnerabilities in database systems to access private customer data that leaves not only the customers susceptible to identity fraud, but also leaves the software development companies vulnerable to litigation procedures for enabling vulnerabilities in their programs. This class showed the importance of always maintaining code security and staying many steps ahead of hackers. 

### Portfolio Artifacts Summary
To demonstrate my skills in Software Design and Engineering, I chose to modify a weather reporting station that runs on a GrovePi platform. The GrovePi has the capability to easily connect a wide range of sensor types, making the process of adding new functionality to the weather station quick and easy. The weather reporting station code is written in my favorite programming language, Python, and the major enhancement made to this project is the inclusion of additional functionality to the embedded device by adding Twitter feed functionality that will tweet the weather data every minute to a specified Twitter account.

To demonstrate my skills in Algorithms and Data Structures, I selected an artifact that was designed to function as a stock market securities information reporting service. The reporting service utilizes a RESTful API web-based protocol to retrieve specified company data in conjunction with a MongoDB database of company stocks information. The artifact was previously designed to retrieve a list of companies that that have the highest number of totals shares outstanding and then group the companies by their respective industry. It was later decided that this artifact could be significantly improved if it could provide potential investors with one of the most important values in respect to stocks, which is 'market capitalization.' The function will be significantly more efficient as it will only need to search for one specified company name and then determine the company’s respective market capitalization, or market cap.

To showcase my skills with databases, the artifact I selected was the same project used to showcase my algorithm and data structure skills, which was designed to function as a stock market securities information reporting service and utilizes a RESTful API web-based protocol to retrieve specified company data in conjunction with a MongoDB database of company stocks information. The improvements made to this artifact consist of incorporating MongoDB statements that will update user-defined values for existing documents using the company’s business ID. The original code simply prompted the user to identify which company ticker abbreviation to use in order to update the “volume” value in the document. Each company document has a large number of values associated with the company’s respective stock market information and prompting the user to identify several specific values to update adds much more functionality and purpose to the program. The user inputs the business ID into the database and will then prompt the user to select which values to update in the document.
